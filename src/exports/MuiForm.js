...
export class MuiForm extends React.Component {
  ...
  constructor(props) {
    ...
    stateScope.state.muiFormValues =
      stateScope.state.muiFormValues !== undefined
        ? stateScope.state.muiFormValues
        : {};
    stateScope.state.muiFormButtons =
      stateScope.state.muiFormButtons !== undefined
        ? stateScope.state.muiFormButtons
        : {};
            ...
            <MuiButton className={"transparent error small"} type="button">
              <b>
                ...
                stateScope.state.muiFormButtons.invalid === true ? (
                  <span>
                    Form not valid.{" "}
                    <div>Please check fields highlighted red.</div>
                  </span>
                ) : (
      ...
      <Styled.FormScrollbars className="MuiForm_customScrollbars">
        <Styled.Form
          ...
          className={
            "MuiForm" +
            (className ? " " + className : "") +
            (stateScope.state.muiFormConnectionFailed
              ? " connectionFailed"
              : "") +
            (stateScope.state.muiFormSubmitAttempted
              ? " submitAttempted"
        ...
        >
            ...
            {stateScope.state.muiFormButtons.reset !== false &&
              ...
              JSON.stringify(stateScope.state.muiFormValues) !==
                ...
                <MuiButton
                  className={""}
                  type="button"
                  onClick={stateScope.muiFormReset}
                >
                  <b>
          ...
          <MuiButton
            ...
            onClick={() => {
              window.$(stateScope.e.form).animate(
                {
                  scrollTop: stateScope.e.form.scrollHeight + "px"
                },
                1000
              );
            }}

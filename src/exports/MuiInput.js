	...
	constructor(props) {
		...
		*/
		this.handleChange = (event, value) => {
			...
			if (
				_get_property(stateScope.state.muiFormValuesOriginal, event.target.name) === undefined
			) {
				_set_property(stateScope.state.muiFormValuesOriginal, event.target.name, '');
			}
			stateScope.setState({
				muiFormTouched: true,
				muiFormChanged:
			...
			this.setState({
				touched: true,
				changed:
					_get_property(stateScope.state.muiFormValuesOriginal, event.target.name) !== value,
			});
